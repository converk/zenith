...
def finalize_actor_batch_config(config: PPOConfig, num_players: int) -> PPOConfig:
    config.batch_size = config.num_envs * num_players * config.num_steps
