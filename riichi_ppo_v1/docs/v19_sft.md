...
`datasets/tenhou_sft_2024_2025_encoded_60pct_v19`，已预处理完成，`epochs=2`）；
...
`belief_sft_coef=1.0`、λ_k 为 hand=0.7 / shanten=0.8 / wait=1.8 /
danger=5.0 / loss=5.0（2026-09-06 按信息量微调，见 PROGRESS.md 阶段 9/10/11/12/15/16）、
