...
TENSORBOARD_DISPLAY_TAGS = {
    ...
    "ppo/system/auxiliary_coef": "PPO/牌效辅助系数 (auxiliary_coef)",
    "ppo/auxiliary_loss": "PPO/牌效辅助损失 (auxiliary_loss)",
    "ppo/update/early_stop": "PPO/提前停止 (early_stop)",
    "reward_scale/discard_weight": "奖励调度/弃牌权重 (discard_weight)",
    "reward_scale/call_weight": "奖励调度/鸣牌权重 (call_weight)",
    "reward_scale/discard_to_kyoku_ratio": "奖励调度/弃牌Trace比例 (discard_to_kyoku_ratio)",
    "reward_scale/call_to_kyoku_ratio": "奖励调度/鸣牌Trace比例 (call_to_kyoku_ratio)",
    ...
    "eval/action/riichi_opportunity_accept_rate": "评测策略/立直机会接受率 (riichi_opportunity_accept_rate)",
    ...
    "eval/fixed/structural_optimal_rate": "评测规则/结构最优率 (structural_optimal_rate)",
    "eval/fixed/rule_tenpai_preference_accuracy": "评测规则/有效听牌偏好准确率 (rule_tenpai_preference_accuracy)",
    "eval/rules/open_no_yaku_tenpai_rate": "评测规则/开放无役听牌率 (open_no_yaku_tenpai_rate)",
    "eval/rules/furiten_tenpai_rate": "评测规则/振听听牌率 (furiten_tenpai_rate)",
    "eval/rules/bad_call_rate": "评测规则/坏鸣牌率 (bad_call_rate)",
