...
CURATED_SCALAR_TAGS = frozenset({
    ...
    "ppo/belief/loss_mae",
    "ppo/belief/loss_conditional_mae",
...
TENSORBOARD_DISPLAY_TAGS = {
    ...
    "ppo/belief/shanten_top1": "PPO/信念/向听 Top-1 (shanten_top1)",
    ...
    "ppo/belief/loss_conditional_mae": "PPO/信念/可荣子集打点 MAE (loss_conditional_mae)",
