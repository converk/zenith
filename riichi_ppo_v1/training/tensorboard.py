...
CURATED_SCALAR_TAGS = frozenset({
    ...
    "ppo/entropy_floor_deficit",
    "ppo/approx_kl",
    "ppo/sft_reference_kl",
    "ppo/clipfrac",
    "ppo/ratio",
    "ppo/ratio_p95",
    # V19 信念监督面（2026-09-07 模糊化）。
    "ppo/belief/hand_accuracy",
    "ppo/belief/wait_tenpai_acc",
    "ppo/belief/wait_top1",
    "ppo/belief/wait_tenpai_acc",
    "ppo/belief/wait_width_mae",
    "ppo/belief/danger_auc",
    "ppo/belief/danger_recall_at_topk",
    "ppo/belief/loss_mae",
    "ppo/belief/loss_bucket_accuracy",
    "ppo/belief/hand_loss",
    "ppo/belief/shanten_loss",
    "ppo/belief/wait_loss",
    "ppo/belief/danger_loss",
    "ppo/belief/loss_loss",
    "ppo/belief/hand_loss_norm",
    "ppo/belief/shanten_loss_norm",
    "ppo/belief/wait_loss_norm",
    "ppo/belief/danger_loss_norm",
    "ppo/belief/loss_loss_norm",
    "ppo/belief/total_loss",
    "ppo/grad_norm",
    ...
    # 逐损失项梯度归因诊断(2026-09-07 探索保持方案配套)。
    "ppo/grad_term/policy/actor",
    "ppo/grad_term/policy/shared",
    "ppo/grad_term/value/critic",
    "ppo/grad_term/value/shared",
    "ppo/grad_term/entropy/actor",
    "ppo/grad_term/entropy/shared",
    "ppo/grad_term/sft_kl/actor",
    "ppo/grad_term/sft_kl/shared",
    "ppo/grad_term/belief/belief",
    "ppo/grad_term/belief/shared",
    "ppo/grad_term/diagnostics_failed",
    # P1 监控/诊断:信念接口使用度 + 反事实开闸②梯度余弦。
    "ppo/belief/token_matrix_weight_norm",
    "ppo/belief/token_matrix_bias_norm",
    "ppo/grad_cos/policy~belief/belief_private",
    "ppo/grad_cos/policy_norm/belief_private",
    "ppo/grad_cos/belief_norm/belief_private",
    "ppo/grad_cos/diagnostics_failed",
    ...
    "ppo/system/belief_public_grad_scale",
...
TENSORBOARD_DISPLAY_TAGS = {
    ...
    "ppo/entropy_floor_deficit": "PPO/熵地板亏额 (entropy_floor_deficit)",
    "ppo/approx_kl": "PPO/近似 KL (approx_kl)",
    "ppo/sft_reference_kl": "PPO/SFT 参考策略 KL (sft_reference_kl)",
    "ppo/belief/hand_accuracy": "PPO/信念/手牌组桶精度 (hand_accuracy)",
    "ppo/belief/wait_tenpai_acc": "PPO/信念/听牌二判精度 (wait_tenpai_acc)",
    "ppo/belief/wait_top1": "PPO/信念/听牌宽度桶 Top-1 (wait_top1)",
    "ppo/belief/wait_tenpai_acc": "PPO/信念/听牌二判精度 (wait_tenpai_acc)",
    "ppo/belief/wait_width_mae": "PPO/信念/待牌宽度 MAE (wait_width_mae)",
    "ppo/belief/danger_auc": "PPO/信念/危险度 AUC (danger_auc)",
    "ppo/belief/danger_recall_at_topk": "PPO/信念/真值可荣牌 top-k 召回 (danger_recall_at_topk)",
    "ppo/belief/loss_mae": "PPO/信念/打点 MAE (loss_mae)",
    "ppo/belief/loss_bucket_accuracy": "PPO/信念/铳点分桶精度 (loss_bucket_accuracy)",
    "ppo/belief/hand_loss": "PPO/信念/手牌损失 (hand_loss)",
    "ppo/belief/shanten_loss": "PPO/信念/向听损失 (shanten_loss)",
    "ppo/belief/wait_loss": "PPO/信念/听牌损失 (wait_loss)",
    "ppo/belief/danger_loss": "PPO/信念/危险度损失 (danger_loss)",
    "ppo/belief/loss_loss": "PPO/信念/打点损失 (loss_loss)",
    "ppo/belief/hand_loss_norm": "PPO/信念/手牌损失·归一化 (hand_loss_norm)",
    "ppo/belief/shanten_loss_norm": "PPO/信念/向听损失·归一化 (shanten_loss_norm)",
    "ppo/belief/wait_loss_norm": "PPO/信念/听牌损失·归一化 (wait_loss_norm)",
    "ppo/belief/danger_loss_norm": "PPO/信念/危险度损失·归一化 (danger_loss_norm)",
    "ppo/belief/loss_loss_norm": "PPO/信念/打点损失·归一化 (loss_loss_norm)",
    "ppo/belief/total_loss": "PPO/信念/联合监督损失 (total_loss)",
    ...
    "ppo/grad_term/policy/actor": "PPO/梯度归因/policy·actor头",
    "ppo/grad_term/policy/shared": "PPO/梯度归因/policy·shared",
    "ppo/grad_term/value/critic": "PPO/梯度归因/value·critic",
    "ppo/grad_term/value/shared": "PPO/梯度归因/value·shared",
    "ppo/grad_term/entropy/actor": "PPO/梯度归因/entropy·actor头",
    "ppo/grad_term/entropy/shared": "PPO/梯度归因/entropy·shared",
    "ppo/grad_term/sft_kl/actor": "PPO/梯度归因/sft_kl·actor头",
    "ppo/grad_term/sft_kl/shared": "PPO/梯度归因/sft_kl·shared",
    "ppo/grad_term/belief/belief": "PPO/梯度归因/belief·信念分支",
    "ppo/grad_term/belief/shared": "PPO/梯度归因/belief·shared",
    "ppo/belief/token_matrix_weight_norm": "PPO/信念接口/token_matrix 权重范数",
    "ppo/belief/token_matrix_bias_norm": "PPO/信念接口/token_matrix 偏置范数",
    "ppo/grad_cos/policy~belief/belief_private": "PPO/梯度诊断/策略×信念监督余弦·反事实(私有)",
    "ppo/grad_cos/policy_norm/belief_private": "PPO/梯度诊断/反事实策略梯度范数(私有)",
    "ppo/grad_cos/belief_norm/belief_private": "PPO/梯度诊断/信念监督梯度范数(私有)",
    "ppo/grad_cos/diagnostics_failed": "PPO/梯度诊断/反事实诊断失败标记",
    "ppo/grad_term/diagnostics_failed": "PPO/梯度归因/诊断失败标记",
    ...
    "ppo/system/belief_public_grad_scale": "PPO/Belief→Shared 梯度倍率 (belief_public_grad_scale)",
