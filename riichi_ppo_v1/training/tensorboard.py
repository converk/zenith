...
TENSORBOARD_DISPLAY_TAGS = {
    ...
    "ppo/belief/hand_accuracy": "PPO/信念/手牌逐格精度 (hand_accuracy)",
    "ppo/belief/shanten_top1": "PPO/信念/向听 Top-1 (shanten_top1)",
    "ppo/belief/wait_auc": "PPO/信念/听牌 AUC (wait_auc)",
    "ppo/belief/wait_conditional_auc": "PPO/信念/听牌行条件 AUC (wait_conditional_auc)",
    "ppo/belief/wait_precision_at_5": "PPO/信念/听牌 Precision@5 (wait_precision_at_5)",
    "ppo/belief/wait_precision_at_2": "PPO/信念/听牌 Precision@2 (wait_precision_at_2)",
    ...
    "ppo/belief/wait_danger_violation": "PPO/信念/Wait≥Danger 违反率 (wait_danger_violation)",
    ...
    "ppo/belief/wait_tenpai_loss": "PPO/信念/听牌二判损失 (wait_tenpai_loss)",
    "ppo/belief/wait_tile_loss": "PPO/信念/听牌牌种损失 (wait_tile_loss)",
    "ppo/belief/danger_loss": "PPO/信念/危险度损失 (danger_loss)",
    "ppo/belief/loss_loss": "PPO/信念/打点损失 (loss_loss)",
    "ppo/belief/wait_danger": "PPO/信念/Wait-Danger 软约束 (wait_danger)",
