...
CURATED_SCALAR_TAGS = frozenset({
    # PPO policy/Q optimisation and policy-drift diagnostics.
    "ppo/policy_loss",
    "ppo/q_loss",
    "ppo/q_loss_raw",
    "ppo/q_boost_loss",
    "ppo/q_target_std",
    "ppo/q_prediction_std",
    "ppo/q_taken_mean",
    "ppo/q_taken_std",
    "ppo/expected_q_mean",
    "ppo/expected_q_std",
    "ppo/qboost_advantage_mean",
    "ppo/qboost_advantage_std",
    "ppo/policy_weighted_legal_q_variance",
...
TENSORBOARD_DISPLAY_TAGS = {
    ...
    "ppo/q_loss": "PPO/Q 损失 (q_loss)",
    "ppo/q_loss_raw": "PPO/原始尺度 Q 损失 (q_loss_raw)",
    "ppo/q_boost_loss": "PPO/Q-Boosting 蒸馏损失 (q_boost_loss)",
    "ppo/q_target_std": "PPO/Q 目标标准差 (q_target_std)",
    "ppo/q_prediction_std": "PPO/Q 预测标准差 (q_prediction_std)",
    "ppo/q_taken_mean": "PPO/Q_taken 均值 (q_taken_mean)",
    "ppo/q_taken_std": "PPO/Q_taken 标准差 (q_taken_std)",
    "ppo/expected_q_mean": "PPO/Expected Q 均值 (expected_q_mean)",
    "ppo/expected_q_std": "PPO/Expected Q 标准差 (expected_q_std)",
    "ppo/qboost_advantage_mean": "PPO/Q-Boosting 优势均值",
    "ppo/qboost_advantage_std": "PPO/Q-Boosting 优势标准差",
    "ppo/policy_weighted_legal_q_variance": "PPO/合法动作策略加权 Q 方差",
    ...
    "ppo/q_explained_variance": "PPO/Q 解释方差 (q_explained_variance)",
    ...
    "ppo/system/q_boost_coef": "PPO/Q-Boosting 系数 (q_boost_coef)",
