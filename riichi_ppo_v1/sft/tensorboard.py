...
SCALAR_TAGS = {
    ...
    "train/belief_hand_acc": "SFT/训练/信念手牌组桶精度 (belief_hand_acc)",
    "train/belief_wait_top1": "SFT/训练/信念听牌宽度桶 Top-1 (belief_wait_top1)",
    "train/belief_wait_tenpai_acc": "SFT/训练/信念听牌二判精度 (belief_wait_tenpai_acc)",
    "train/belief_wait_width_mae": "SFT/训练/信念待牌宽度 MAE (belief_wait_width_mae)",
    ...
    "train/belief_loss_bucket_accuracy": "SFT/训练/铳点分桶精度 (belief_loss_bucket_accuracy)",
    "train/belief_hand_loss": "SFT/训练/信念手牌损失 (belief_hand_loss)",
    "train/belief_loss_bucket_loss": "SFT/训练/铳点分桶损失 (belief_loss_bucket_loss)",
    ...
    "train/belief_hand_loss_norm": "SFT/训练/信念手牌损失·归一化 (belief_hand_loss_norm)",
    "train/belief_loss_bucket_loss_norm": "SFT/训练/铳点分桶损失·归一化 (belief_loss_bucket_loss_norm)",
    "train/belief_wait_loss_norm": "SFT/训练/信念听牌损失·归一化 (belief_wait_loss_norm)",
...
# 训练窗口里随 batch 加权累计的信念指标（模糊化后）。
BELIEF_METRIC_KEYS = (
    "belief_hand_acc",
    "belief_wait_tenpai_acc",
    "belief_wait_top1",
    "belief_wait_tenpai_acc",
    "belief_wait_width_mae",
    "belief_danger_recall_at_topk",
    "belief_loss_bucket_accuracy",
    "belief_loss_expected_mae",
    "belief_hand_loss",
    "belief_loss_bucket_loss",
    "belief_wait_loss",
    "belief_danger_loss",
    "belief_loss_loss",
    "belief_hand_loss_norm",
    "belief_loss_bucket_loss_norm",
    "belief_wait_loss_norm",
    "belief_danger_loss_norm",
    "belief_loss_loss_norm",
